...
#'
#' @details
#' This function executes the CovCoagFullPrediction Study.
#' 
  ...
  if(createValidationPackage){
    ...
    if(!saveModelsToJson){
      ...
      tryCatch({
        ...
        createValidationPackageJson(devPackageName = 'CovCoagFullPrediction',
                                    devDatabaseName = cdmDatabaseName,
                                    analysisLocation = outputFolder,
                                    analysisIds = analysesToValidate,
                                    outputFolder = outputFolder,
                                    packageName = 'CovCoagFullPredictionValidation',
                                    description = 'validating models in CovCoagFullPrediction',
                                    skeletonVersion = skeletonVersion,
                                    createdBy = 'anonymous',
